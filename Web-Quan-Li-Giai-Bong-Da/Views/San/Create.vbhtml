...
@Using (Html.BeginForm()) 
    ...
    @<div class="form-horizontal">
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.MaSan, htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                @Html.EditorFor(Function(model) model.MaSan, New With { .htmlAttributes = New With { .class = "form-control" } })
